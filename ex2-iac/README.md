...
The *free* services of both should suffice for the course exercises.
...
LTS, the GNU/Linux I distribution I use.
...
The AWS CLI can be configured after creating API access keys:
...
I want to read AWS CLI output as opposed to using it as input for other
AWS CLI commands,
thus I set the default to `table`.
I would have used `yaml` if supported,
because I find YAML better readable than JSON.
